    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
      ...
      <div className="lg:col-span-5 flex flex-col space-y-6 text-left">
        <div>
          ...
          <div className="flex items-cols space-x-3 mt-3">
        ...
        <div className="pt-4">
          <button 
            ...
            disabled={!activeSize && activeVariant?.sizes?.length > 0}
          ...
          >
            {activeSize || activeVariant?.sizes?.length === 0 ? 'Add To Royal Bag' : 'Select A Size First'}
          </button>
        </div>
